package com.swapnilsankla.cdc.loanfulfilment
...
import com.swapnilsankla.cdc.loanfulfilment.model.LoanApplication
...
class LoanFulfilmentConsumerTest {
    ...
    @Test
    @PactTestFor(pactMethod = "eventForLoanFulfilment")
